...
function setUser(
    ...
    if(param === "marketing" && typeof newValue == "boolean") target[param] = newValue;
    else if (param === "detail" && newValue instanceof IDetail) target[param] = newValue;
...
const detail : IDetail  = new IDetail("jaeseok", 30, "seoul")
const user : IUser = {
    detail,
    marketing : true,
    sns : "KAKAO"
